...
measurements.line_plot(control_speed, exp_speed, dt, wound_slice, labels,
                       x_label='time (min)', y_label='speed (um/s)')

# Plot mean normalized speeds from PIV
...
measurements.line_plot(control_speed_normalized, exp_speed_normalized, dt, wound_slice, labels,
                       x_label='time (min)', y_label='normalized speed')

# Plot mean directedness from PIV
measurements.line_plot(control_directedness, exp_directedness, dt, wound_slice, labels,
                       x_label='time (min)', y_label='directedness')

# Plot mean normalized directedness from PIV
...
measurements.line_plot(control_directedness_normalized, exp_directedness_normalized, dt, wound_slice, labels,
                       x_label='time (min)', y_label='normalized directedness')
...
measurements.bar_plot(control_speed_before, control_speed_after, pre_labels, "speed (um/s)", method='PT', n_colors=1)
...
measurements.bar_plot(control_delta_speed, exp_delta_speed, labels,
                      "% change in speed", method='T', n_colors=2)
...
measurements.bar_plot(control_delta_directedness, exp_delta_directedness, labels,
                      "% change in directedness", method='T', n_colors=2)
...
measurements.bar_plot(control_directedness_before, control_directedness_after,
                      pre_labels, "directedness", method='PT', n_colors=1)
...
measurements.bar_plot(control_delta_number, exp_delta_number, labels,
                      "change in nuclear count", method='T', n_colors=2)
...
measurements.bar_plot(control_count_before, control_count_after,
                      pre_labels, "nuclear count", method='PT', n_colors=1)
...
measurements.bar_plot(control_trackpy_delta_speed, exp_trackpy_delta_speed,
                      labels, "% change in speed", method='T', n_colors=2)
...
measurements.bar_plot(control_trackpy_delta_directedness, exp_trackpy_delta_directedness,
                      labels, "% change in directedness", method='T', n_colors=2)
...
measurements.bar_plot(control_trackpy_number, exp_trackpy_number, labels, "change in nuclear count",
                      method='T', n_colors=2)